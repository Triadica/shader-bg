...
class PetalSphereRenderer {
  ...
  private func setupPipeline() {
    ...
    let vertexFunction = library.makeFunction(name: "petalSphereVertex")
    let fragmentFunction = library.makeFunction(name: "petalSphereFragment")
  ...
  private func setupBuffers() {
    ...
    paramsBuffer = device.makeBuffer(
      length: MemoryLayout<PetalSphereParams>.stride,
  ...
  private func updateParams(viewportSize: CGSize) {
    ...
    paramsBuffer.contents().copyMemory(
      from: &params, byteCount: MemoryLayout<PetalSphereParams>.stride)
  }
}
