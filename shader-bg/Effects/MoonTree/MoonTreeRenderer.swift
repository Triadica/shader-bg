...
class MoonTreeRenderer {
  ...
  private func setupPipeline() {
    ...
    let vertexFunction = library.makeFunction(name: "moonTreeVertex")
    let fragmentFunction = library.makeFunction(name: "moonTreeFragment")
  ...
  private func setupBuffers() {
    ...
    paramsBuffer = device.makeBuffer(
      length: MemoryLayout<MoonTreeParams>.stride,
  ...
  private func updateParams(viewportSize: CGSize) {
    ...
    paramsBuffer.contents().copyMemory(
      from: &params, byteCount: MemoryLayout<MoonTreeParams>.stride)
  }
}
