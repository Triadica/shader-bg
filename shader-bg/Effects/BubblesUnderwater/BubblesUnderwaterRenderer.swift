//
//  BubblesUnderwaterRenderer.swift
//  shader-bg
//
...
class BubblesUnderwaterRenderer {
  ...
  private func setupPipeline() {
    ...
    let vertexFunction = library.makeFunction(name: "bubblesUnderwaterVertex")
    let fragmentFunction = library.makeFunction(name: "bubblesUnderwaterShader")
  ...
  private func setupBuffers() {
    ...
    paramsBuffer = device.makeBuffer(
      length: MemoryLayout<BubblesUnderwaterParams>.stride,
  ...
  func draw(in view: MTKView) {
    ...
    renderPassDescriptor.colorAttachments[0].clearColor = MTLClearColor(
      red: 0.0, green: 0.1, blue: 0.2, alpha: 1.0)
  ...
  private func updateParams(viewportSize: CGSize) {
    ...
    var params = BubblesUnderwaterParams(
      time: time,
    ...
    paramsBuffer.contents().copyMemory(
      from: &params, byteCount: MemoryLayout<BubblesUnderwaterParams>.stride)
  }
}
