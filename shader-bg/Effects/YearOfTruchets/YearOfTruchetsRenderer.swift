...
class YearOfTruchetsRenderer {
  ...
  private func setupPipeline() {
    ...
    let vertexFunction = library.makeFunction(name: "yearOfTruchetsVertex")
    let fragmentFunction = library.makeFunction(name: "yearOfTruchetsFragment")
  ...
  private func setupBuffers() {
    ...
    paramsBuffer = device.makeBuffer(
      length: MemoryLayout<YearOfTruchetsParams>.stride,
  ...
  private func updateParams(viewportSize: CGSize) {
    ...
    var params = YearOfTruchetsParams(
      time: time,
    ...
    paramsBuffer.contents().copyMemory(
      from: &params, byteCount: MemoryLayout<YearOfTruchetsParams>.stride)
  }
}
