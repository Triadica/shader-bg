...
class FloatingBubblesRenderer {
  ...
  private func setupPipeline() {
    ...
    guard let kernelFunction = library.makeFunction(name: "floatingBubblesCompute") else {
      print("Failed to create kernel function: floatingBubblesCompute")
      return
    }
