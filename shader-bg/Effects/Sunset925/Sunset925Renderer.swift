...
class Sunset925Renderer {
  ...
  private func setupPipeline() {
    ...
    guard let kernelFunction = library.makeFunction(name: "sunset925Compute") else {
      print("Failed to create kernel function: sunset925Compute")
      return
    }
