...
class GlowyOrbRenderer {
  ...
  private func setupPipeline() {
    ...
    let vertexFunction = library.makeFunction(name: "glowyOrbVertex")
    let fragmentFunction = library.makeFunction(name: "glowyOrbFragment")
  ...
  private func setupBuffers() {
    ...
    paramsBuffer = device.makeBuffer(
      length: MemoryLayout<GlowyOrbParams>.stride,
  ...
  private func updateParams(viewportSize: CGSize) {
    ...
    paramsBuffer.contents().copyMemory(
      from: &params, byteCount: MemoryLayout<GlowyOrbParams>.stride)
  }
}
