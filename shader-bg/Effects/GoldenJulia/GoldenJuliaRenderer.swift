...
class GoldenJuliaRenderer {
  ...
  private func setupPipeline() {
    ...
    let vertexFunction = library.makeFunction(name: "goldenJuliaVertex")
    let fragmentFunction = library.makeFunction(name: "goldenJuliaFragment")
  ...
  private func setupBuffers() {
    ...
    paramsBuffer = device.makeBuffer(
      length: MemoryLayout<GoldenJuliaParams>.stride,
  ...
  private func updateParams(viewportSize: CGSize) {
    ...
    paramsBuffer.contents().copyMemory(
      from: &params, byteCount: MemoryLayout<GoldenJuliaParams>.stride)
  }
}
