...
class DroppyThingiesRenderer {
  ...
  private func setupPipeline() {
    ...
    guard let kernelFunction = library.makeFunction(name: "droppyThingiesCompute") else {
      print("Failed to create kernel function: droppyThingiesCompute")
      return
    }
