...
class SinsAndStepsRenderer {
  ...
  private func setupPipeline() {
    ...
    let vertexFunction = library.makeFunction(name: "sinsAndStepsVertex")
    let fragmentFunction = library.makeFunction(name: "sinsAndStepsFragment")
  ...
  private func setupBuffers() {
    ...
    paramsBuffer = device.makeBuffer(
      length: MemoryLayout<SinsAndStepsParams>.stride,
  ...
  private func updateParams(viewportSize: CGSize) {
    ...
    paramsBuffer.contents().copyMemory(
      from: &params, byteCount: MemoryLayout<SinsAndStepsParams>.stride)
  }
}
