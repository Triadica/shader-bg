...
class InputEventManager {
  ...
  private func isOnDesktop(location: NSPoint) -> Bool {
    ...
    for windowInfo in windowList {
      ...
      // 跳过某些系统进程
      let skipProcesses = ["Window Server", "Dock", "SystemUIServer", "Control Center", "Notification Center"]
  ...
  private func handleMouseClick(_ event: NSEvent) {
    ...
    NSLog("[InputEventManager] 鼠标点击产生涟漪: (\(normalized.x), \(normalized.y)) 显示器: \(screenIndex), 当前涟漪总数: \(rippleEvents.count)")
  }
  ...
  private func keyCodeToPosition(_ keyCode: UInt16) -> SIMD2<Float> {
    ...
    switch keyCode {
    // 数字行 (row 0)
    case 50: row = 0.0; col = 0.0  // `
    case 18: row = 0.0; col = 1.0  // 1
    case 19: row = 0.0; col = 2.0  // 2
    case 20: row = 0.0; col = 3.0  // 3
    case 21: row = 0.0; col = 4.0  // 4
    case 23: row = 0.0; col = 5.0  // 5
    case 22: row = 0.0; col = 6.0  // 6
    case 26: row = 0.0; col = 7.0  // 7
    case 28: row = 0.0; col = 8.0  // 8
    case 25: row = 0.0; col = 9.0  // 9
    case 29: row = 0.0; col = 10.0 // 0
    case 27: row = 0.0; col = 11.0 // -
    case 24: row = 0.0; col = 12.0 // =
    
    // QWERTY 行 (row 1)
    case 12: row = 1.0; col = 0.5  // Q
    case 13: row = 1.0; col = 1.5  // W
    case 14: row = 1.0; col = 2.5  // E
    case 15: row = 1.0; col = 3.5  // R
    case 17: row = 1.0; col = 4.5  // T
    case 16: row = 1.0; col = 5.5  // Y
    case 32: row = 1.0; col = 6.5  // U
    case 34: row = 1.0; col = 7.5  // I
    case 31: row = 1.0; col = 8.5  // O
    case 35: row = 1.0; col = 9.5  // P
    case 33: row = 1.0; col = 10.5 // [
    case 30: row = 1.0; col = 11.5 // ]
    
    // ASDF 行 (row 2)
    case 0: row = 2.0; col = 0.75  // A
    case 1: row = 2.0; col = 1.75  // S
    case 2: row = 2.0; col = 2.75  // D
    case 3: row = 2.0; col = 3.75  // F
    case 5: row = 2.0; col = 4.75  // G
    case 4: row = 2.0; col = 5.75  // H
    case 38: row = 2.0; col = 6.75 // J
    case 40: row = 2.0; col = 7.75 // K
    case 37: row = 2.0; col = 8.75 // L
    case 41: row = 2.0; col = 9.75 // ;
    case 39: row = 2.0; col = 10.75 // '
    
    // ZXCV 行 (row 3)
    case 6: row = 3.0; col = 1.25  // Z
    case 7: row = 3.0; col = 2.25  // X
    case 8: row = 3.0; col = 3.25  // C
    case 9: row = 3.0; col = 4.25  // V
    case 11: row = 3.0; col = 5.25 // B
    case 45: row = 3.0; col = 6.25 // N
    case 46: row = 3.0; col = 7.25 // M
    case 43: row = 3.0; col = 8.25 // ,
    case 47: row = 3.0; col = 9.25 // .
    case 44: row = 3.0; col = 10.25 // /
    
    // 空格行 (row 4)
    case 49: row = 4.0; col = 5.5  // Space
    
    // 方向键
    case 123: row = 4.5; col = 12.0 // Left
    case 124: row = 4.5; col = 14.0 // Right
    case 126: row = 3.5; col = 13.0 // Up
    case 125: row = 4.5; col = 13.0 // Down
  ...
  private func resetMouseActivityTimer() {
    mouseActivityTimer?.invalidate()
    mouseActivityTimer = Timer.scheduledTimer(withTimeInterval: mouseActivityTimeout, repeats: false) { [weak self] _ in
...
struct InputState {
  ...
  init(hasMouseActivity: Bool, mousePosition: SIMD2<Float>, keyPositions: [SIMD2<Float>], 
